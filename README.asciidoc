...
ready:: Toggle player status to be "ready", if there is warmup
notready (unready/noready):: Toggle player status to be "not ready", if there is warmup
...
forceready (allready/readyall)::
    Force all players to become "ready". Starts the countdown.

unreadyall (allnotready/notreadyall)::
    Force all players to become "not ready". Aborts the countdown.
...
g_warmup::
    ...
    for match to start. Works for 2 players, at least. Default value is 0.
